...
angular.module('mean.users')
  ...
  .controller('LoginCtrl', ['$scope', '$rootScope', '$http', '$location', 'Global',
    function($scope, $rootScope, $http, $location, Global) {
      ...
      $scope.user = {email:'xieyi@uzhu.com.cn',password:'Xieyi0830!@#'};
      $scope.global = Global;
      ...
      $scope.togglePasswordVisible = function() {
        ...
        $scope.input.placeholder = $scope.input.placeholder === '密码' ? '可见密码' : '密码';
  ...
  .controller('RegisterCtrl', ['$scope', '$rootScope', '$http', '$location', 'Global',
    function($scope, $rootScope, $http, $location, Global) {
      ...
      $scope.togglePasswordConfirmVisible = function() {
        $scope.input.type = $scope.input.type === 'text' ? 'password' : 'text';
        $scope.input.placeholderConfirmPass = $scope.input.placeholderConfirmPass === '确认密码' ? '可见密码' : '确认密码';
